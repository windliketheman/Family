...
@dynamic messageType;
@dynamic messageId;
@dynamic messageChatType;
@dynamic messageLocalPath;
@dynamic messageDuration;
@dynamic messageProgress;
@dynamic messageSize;
@dynamic messageThumbnail;
@dynamic messageUrl;
@dynamic messageIsSuccess;
@dynamic messageIsRead;
@dynamic messageFileLocalPath;

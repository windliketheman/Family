...
@property (nonatomic, strong) NSString * messageLocalPath;

@property (nonatomic, strong) NSString * messageChatType;
@property (nonatomic, strong) NSString * messageDuration;
@property (nonatomic, strong) NSString * messageProgress;

@property (nonatomic, strong) NSString * messageSize;

@property (nonatomic, strong) NSString * messageThumbnail;
@property (nonatomic, strong) NSString * messageUrl;
@property (nonatomic, strong) NSString * messageIsSuccess;
@property (nonatomic, strong) NSString * messageIsRead;
@property (nonatomic, strong) NSString * messageFileLocalPath;

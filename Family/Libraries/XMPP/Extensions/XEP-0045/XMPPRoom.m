...
- (void)configureRoomUsingOptions:(NSXMLElement *)roomConfigForm
{
	dispatch_block_t block = ^{ @autoreleasepool {
		...
		if (roomConfigForm)
		{
            ...
            NSXMLElement *fieldMembersonly = [NSXMLElement elementWithName:@"field"];
            [fieldMembersonly addAttributeWithName:@"var" stringValue:@"muc#roomconfig_membersonly"];
            [x addChild:fieldMembersonly];

...
- (void)queryNextProxyCandidate
{
	...
	{
        NSLog(@"proxyCandidateIndex : %lu",(unsigned long)proxyCandidateIndex);
...
- (void)targetNextConnect
{
	...
	streamhostIndex++;
    NSLog(@"targetNextConnect  streamhostIndex : %lu----- streamhosts: %@",(unsigned long)streamhostIndex,streamhosts);
